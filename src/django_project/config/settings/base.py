...
# CONFIG_DIR points to config package.
CONFIG_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# BASE_DIR points to starting point of the projects's base directory path.
...
# APPS_DIR points to the core package.
...
STATIC_ROOT = os.path.join(ASSETS_MEDIA_DIR, 'assets')

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(ASSETS_MEDIA_DIR, 'media')